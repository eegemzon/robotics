...
r = IO.PWM(rightSM,50)
l = IO.PWM(leftSM,50)                            # generate PWM signal with 7.5% duty cycle

print 'Preparing arms movements...'

def testing():
	l.start(7.5)       # base 0 degrees           
	r.start(7.9)       # base 90 degrees  our initial position 
	time.sleep(0.3) 
	l.ChangeDutyCycle(6.5)       # base 0 degrees           
	r.ChangeDutyCycle(6.5)       # base 90 degrees  our initial position 
	time.sleep(0.3)
	l.start(7.5)       # base 0 degrees           
	r.start(7.9)       # base 90 degrees  our initial position 
	time.sleep(0.3) 
...
#	l.ChangeDutyCycle(12.5)      # base 180 degrees            
#	time.sleep(2)              
